        ...
        <main className=' bg-white'>
            ...
            <div className='pt-2 md:pt-10  pb-18 grid grid-rows lg:grid-cols-[2fr_1fr] lg:max-w-5xl mx-auto'>
                ...
                <div className='px-4 pr-10'>
                    ...
                    <p className='text-xs text-gray-600 mb-7'>The very first batch of Qadri Khair  Home, filled with gratitude and reverence, affectionately
                    ...
                    <p className='text-xs text-gray-600 mb-7'>By the end of 2018, Qadri Khair  Home had grown to house 10–20 students, all boys. However, a significant change came in 2019, when Qadri Khair  began welcoming girls as well. During his visits to slum areas, Mr. Rahmani noticed how girls would look up to him with silent hope, yearning for the opportunities their brothers were receiving. Their unspoken pleas resonated deeply with him, and he expanded Qadri Khair ’s mission to include them.</p>
                    <p className='text-xs text-gray-600 mb-7'>What began as Qadri Khair  Home for a handful of children soon evolved into a miniature school. Over time, its reputation spread, and the number of students swelled. Unable to turn away any child seeking help, Mr. Rahmani and his team embraced the challenge of accommodating all. By the end of 2019, Qadri Khair  Home had grown from three to sixty students—an equal number of boys and girls.</p>
                    <p className='text-xs text-gray-600 mb-4'>As the institution grew, so did its aspirations. What once operated on a 1200 sq. ft. apartment slowly expanded into 6000 sq. ft. premises growing from Qadri Khair  Home to Qadri Khair  Academy.</p>

                    <div className='max-w-125'>
                        <Image src='/assets/gallery1.jpg' alt='Gallery image 1' width={600} height={400} className='w-full h-full object-cover' />
                    </div>

                    <p className='text-xs text-gray-600 my-7'>By the end of 2021, Mr. Rahmani’s unwavering resilience started bearing fruit as Qadri Khair  Academy’s name gained prominence across the city and started establishing its credibility. The pilot project that Mr. Rahmani had already been working upon for the past four years now just required the right foundation to grow and take flight. This vision started converting
                        into reality when he acquired a 2-acre land in 2022, and in 2023, the construction for Qadri Khair Foundation started.</p>
                    ...
                    <p className='text-xs text-gray-600 mb-7'>With the inflow of funds, construction gained momentum. What had once seemed like an uphill battle turned into a remarkable feat. And then, another historic milestone was achieved—the school was not only built but fully completed within just 365 days from the time the crowdfunding took place. By September 2024, a fully functional institution stood
                        tall—equipped with classrooms, facilities, and a promise of a brighter future for countless children. Qadri Khair Foundation opened its gates to its first batch of students from KG to Class 7—a testament to the unwavering dedication of its founder and supporters.</p>
                    <p className='text-xs text-gray-600 mb-7'>Today, Qadri Khair Foundation serves over 400 children, primarily from disadvantaged and volatile backgrounds. These children, who once faced an uncertain future, are now embraced by a nurturing environment that empowers them to heal, learn, and grow. They are no longer mere victims of circumstance but torchbearers of hope and agents of change.</p>
                    <p className='text-xs text-gray-600 mb-7'>The journey from Qadri Khair  Home to Qadri Khair Foundation is a story of resilience, vision, and relentless faith. It is a testament to the power of education as a tool for liberation and transformation. With every child who walks through its doors, Qadri Khair  continues to build a legacy of hope—a legacy that defies the odds and inspires the world to dream of a better tomorrow.</p>
