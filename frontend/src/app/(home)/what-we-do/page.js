        ...
        <main className='bg-white'>
            ...
            <div className='py-5 pb-12 text-black grid grid-rows lg:grid-cols-[2fr_1fr] lg:max-w-5xl mx-auto'>
                ...
                <div className='px-4 pr-10'>
                    ...
                    <p className='text-xs text-gray-600 my-8'>Umeed Global School is proud to offer a comprehensive curriculum that integrates Science, Technology, Engineering, and Mathematics (STEM) disciplines. We believe that a strong foundation in STEM empowers students to become critical thinkers, innovative problemsolvers, and future pioneers in scientific discovery and technological advancement. To further enhance STEM learning, we have established an Innovation and Technology Lab that provides hands-on learning experiences in Robotics, AI, Coding, Data Analytics, 3D Designing & Printing, and Drone Technology. These subjects encourage students to explore emerging technologies, equipping them with the skills required to succeed in an ever-evolving digital world.</p>
                    <p className='text-xs text-gray-600 my-8'>At Umeed Global School, we offer six language subjects: English, Hindi, Bengali, Arabic,
                    ...
                    <p className='text-xs text-gray-600 my-8'>At Umeed Global School, we strive to create an inspiring learning environment where academic excellence is blended with ethical values, innovation is nurtured alongside spiritual growth, and students are shaped into intelligent, responsible, and forward-thinking individuals prepared for the challenges of the modern world.</p>
                    ...
                    <p className='text-xs text-gray-600 my-8'>At Umeed Global School, education and Tarbiyah (nurturing/upbringing) go hand in hand, forming the bedrock of a child’s holistic development. Too often, education is reduced to academics, at Umeed Global School we believe that academics is just a single drop in the vast ocean of learning, while Tarbiyah encompasses the rest. It is Tarbiyat that shapes character, instills values, and nurtures identity. Sadly, this essential aspect of upbringing is often overlooked, though it is a lifelong journey, woven into every moment, guiding children not just in what to think, but in how to think, act, and conduct themselves also.</p>
                    ...
                    <p className='text-xs text-gray-600 my-2'>At Umeed Global School, we believe that a healthy body and mind are the cornerstone of a child’s overall development. Many of our students come from impoverished and challenging backgrounds, where access to proper nutrition and healthcare is scarce. Usually when students from especially weaker sections of society join us, they are weak, malnourished, and show signs of stunted growth. Through our dedicated efforts, we have been able to restore their health, ensuring they not only look healthier but also feel physically and emotionally fit.</p>
                    ...
                    <p className='text-xs text-gray-600 my-7'>To ensure our students remain in the best of health, Umeed Global School conducts four comprehensive health check-ups annually, focusing on areas that are often neglected in underserved communities: general health check-up, dental check-up, eye examination, and ENT (ear, nose, and throat) check-up.</p>
                    ...
                    <p className='text-xs text-gray-600 my-7'>At Umeed Global School, our health and nutrition program reflects our mission to nurture our children into well nourished, healthy individuals. By addressing their nutritional and healthcare needs, we aim to provide them with a solid foundation for a brighter and healthier future.</p>
                    ...
                    <Slider/>
                    <p className='text-xs text-gray-600 my-1'>At Umeed Global School, we believe holistic development thrives in an immersive environment. Our compulsory Residential Programme provides a structured, value-driven space where students experience personal growth, academic excellence, and character building under the continuous guidance of House Parents.</p>
                    ...
                    <p className='text-xs text-gray-600 my-7'>At Umeed Global School, we believe that every child deserves a chance to learn, dream, and build a brighter future—regardless of their financial background. For us, education is not just about books and classrooms; it's about nurturing potential and creating opportunities.</p>
                    ...
                    <Slider/>
                    <p className='text-xs text-gray-600 my-1'>At Umeed Global School, we believe that education is not just about memorizing facts and passing exams—it’s about shaping young minds, building character, and preparing our students for life. For us, a school is not just a place where lessons are taught; it’s a space where dreams take flight, confidence is built, and values are nurtured.</p>
